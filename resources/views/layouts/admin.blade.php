                  ...
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                        <a class="dropdown-item" href="{{ url('user', [Auth::user()->encode_id]) }}">{{ __('Perfil') }} <span class="iconify ml-auto" data-icon="el:user" data-inline="false"></span></a>
                        <a class="dropdown-item" href="{{ url('logins', [Auth::user()->encode_id]) }}">{{ __('Logins') }} <span class="iconify ml-auto" data-icon="oi-account-login" data-inline="false"></span></a>
                        <div class="dropdown-divider"></div>
                           <a href="logout" class="dropdown-item" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Salir
                        <span class="iconify ml-auto" data-icon="websymbol-logout" data-inline="false"></span>
                      </a>
